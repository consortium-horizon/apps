...
<div class="BoxFilter BoxDiscussionFilter">
    <ul class="FilterMenu">
        ...
        <li class="Discussions<?php echo strtolower($Controller->ControllerName) == 'discussionscontroller' && strtolower($Controller->RequestMethod) == 'unread' ? ' Active' : ''; ?>"><?php echo Gdn_Theme::Link('discussions/unread',t('Unread Discussions')); ?></li>
