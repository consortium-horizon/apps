jQuery(document).ready(function($){
	...
	function initTour() {
		...
		tourTrigger.on('click', function(){
			...
			if(!tourWrapper.hasClass('active')) {
				...
				$(document.body).addClass('tutorial-mode');
	...
	function createNavigation(steps, n) {
		var tourNavigationHtml = '<div class="cd-nav"><span><b class="cd-actual-step">1</b> sur '+n+'</span><ul class="cd-tour-nav"><li><a href="#0" class="cd-prev">&#171; Précédent</a></li><li><a href="#0" class="cd-next">Suivant &#187;</a></li></ul></div><a href="#0" class="cd-close">Close</a>';
