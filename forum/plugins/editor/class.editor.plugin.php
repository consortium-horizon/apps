...
class EditorPlugin extends Gdn_Plugin {
    ...
    */
    ...
    protected function getEditorToolbar($attributes = array()) {
        ...
        $editorToolbarAll['underline'] = array('edit' => 'basic', 'action' => 'underline', 'type' => 'button', 'attr' => array('class' => 'editor-action icon icon-underline editor-dialog-fire-close', 'data-wysihtml5-command' => 'underline', 'title' => t('Underline'), 'data-editor' => '{"action":"underline","value":""}'));
