 ...
 * This file has been modified and distributed with Post Scheduler plugin. The
 ...
 * uninstalled, as the changes won't have an impact on Vanilla's normal operations.
...
if(class_exists('ActivityModel', FALSE)) {
	return;
}
...
//			}
	 ...
	 /**
		* Inserts a row in Activity table, triggering a Before and After events.
		*
		* @param array Fields An array of Field => Value pairs, which will be used
		* to populate the Activity table.
		* @return int|mixed The ID of the inserted Activity, False or null if
	 ...
	 /**
		* Updates a row in Activity table, triggering a Before and After events.
		*
		* @param array Fields An array of Field => Value pairs, which will be used
		* to populate the Activity table.
		* @param array Wheres An array of WHERE clauses.
		* @param int Limit The maximum amount of rows to update.
		* @return mixed The return value of Gdn_Model::Update().
		* @see Gdn_Model::Update()
		*/
...
\Aelia\OverridesManager::RegisterOverride('ActivityModel');
