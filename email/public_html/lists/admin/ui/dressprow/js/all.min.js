...
$(document).ready(function(){$(".note .hide").click(function(){$(this).parents('.note').hide();});$(".configurelink").click(function(){$("#configurecontent").load('./?page=ajaxcall&action=test');$("#configurecontent").show();return false;});$("a.ajaxable").click(function(){var url=this.href;var thispage=urlParameter('page',window.location.href);var action=urlParameter('action',url);if(action==""){url+='&action='+thispage;}
...
$("#subjectinput").blur(function(){if(this.value==""){this.value="(no subject)";return;}});$("#remoteurlinput").focus(function(){if(this.value=='e.g. http://www.phplist.com/testcampaign.html'){this.value="";}})
...
$('.actionresult').delay(4000).fadeOut(4000);$('.result').delay(4000).fadeOut(4000);$("#spinner").html(busyImage);$("#stopqueue").click(function(){$("#processqueueoutput").html('Processing cancelled');$("#spinner").html('&nbsp;');$("#stopqueue").hide();$("#resumequeue").show();});var docurl=document.location.search;document.cookie="browsetrail="+escape(docurl);setTimeout("autoSave();",500);});function allDone(text){if(!text){text='All done';}
